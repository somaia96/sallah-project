    ...
    >
      {data?.map((item: IDataType)=>{
        ...
        <CardFooter dir="rtl" className="flex justify-center items-stretch gap-2 w-[100%]">
          <Button dir="rtl" className="font-bold flex gap-2 bg-transparent font-bold text-gray-600 w-[100%] border-2 border-gray-100"><svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
