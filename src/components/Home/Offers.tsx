...
const Offers = () => {
  return (
    <div className='py-5'>
     ...
     <div className='grid w-[100%] grid-cols-[repeat(auto-fill,minmax(48%,1fr))] gap-3'>
     <div className="relative ">
            <span className="new bg-[--primary] relative top-[60px] left-[calc(100%-212px)] text-white p-2 z-[1]">جديد</span>
