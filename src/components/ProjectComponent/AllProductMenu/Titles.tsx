...
const Titles = () => {
  return (
    <div className='Titles z-10 sm:[position:unset] absolute bg-opacity-90 sm:bg-opacity-100 h-[100vh] sm:h-[44px] sm:relative w-[100%] right-0 top-0 text-black bg-[#1D1F1F] sm:text-white'>
      <div className="sm:container sm:[position:unset] overflow-hidden z-10 absolute sm: right-0 top-0 h-[100%] border bg-white sm:border-none flex-col w-[342px] sm:w-[100%] sm:bg-[#1D1F1F] sm:flex-row flex lg:gap-[24px] px-[16px] sm:justify-center" dir="rtl">
